...
static integer c__327 = 327;
static integer c__328 = 328;
static integer c__781 = 781;
...
/* Builtin functions */
   integer s_wsfe(cilist *), do_fio(integer *, char *, ftnlen), e_wsfe(void), f_clos(cllist *);
...
#define switch__ ((integer *)&findex_1 + 46)
   ...
   static integer l;
   extern /* Subroutine */ int encryp_(char *, char *, ftnlen, ftnlen);
   static char ch[1 * 6];
   static integer cp, wp;
