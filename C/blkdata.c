...
#define buzvoc_1 (*(struct buzvoc_1_ *) &buzvoc_)

struct prpvoc_1_ {
   integer pvoc[45];
};

#define prpvoc_1 (*(struct prpvoc_1_ *) &prpvoc_)

struct dirvoc_1_ {
   integer dvoc[75];
};

#define dirvoc_1 (*(struct dirvoc_1_ *) &dirvoc_)
...
#define adjvoc_1 (*(struct adjvoc_1_ *) &adjvoc_)
#define adjvoc_2 (*(struct adjvoc_2_ *) &adjvoc_)
...
#define vrbvoc_1 (*(struct vrbvoc_1_ *) &vrbvoc_)
#define vrbvoc_2 (*(struct vrbvoc_2_ *) &vrbvoc_)
...
#define objvoc_1 (*(struct objvoc_1_ *) &objvoc_)
#define objvoc_2 (*(struct objvoc_2_ *) &objvoc_)
