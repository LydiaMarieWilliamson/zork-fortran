...
test: $(APP)
	...
	./$(APP) 657577982 <Test.in > ExB && diff -d TestB.ex ExB && rm ExB && \
	./$(APP) 657577797 <Test.in > ExC && diff -d TestC.ex ExC && rm ExC && \
	./$(APP) 657578356 <Test2.in > ExD && diff -d TestD.ex ExD && rm ExD && \
	echo "Tests passed."
