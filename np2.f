...
D10	FORMAT(' SCHLST- ROOM SCH ',I6)
        ...
        IF(OBJ.LT.0) GO TO 1000
        IF(OBJ.EQ.0) GO TO 200
C       IF(OBJ.GT.0) GO TO 100
C						!TEST RESULT.
...
D20	FORMAT(' SCHLST- VEH SCH  ',I6)
        ...
        IF(NOBJ.LT.0) GO TO 1100
        IF(NOBJ.EQ.0) GO TO 400
C       IF(NOBJ.GT.0) GO TO 300
C						!TEST RESULT.
300	CHOMP=.FALSE.
C						!REACHABLE.
...
D30	FORMAT(' SCHLST- ADV SCH  ',I6)
        ...
        IF(NOBJ.LT.0) GO TO 1100
        IF(NOBJ.EQ.0) GO TO 600
C       IF(NOBJ.GT.0) GO TO 500
C						!TEST RESULT
