...
//     & 3ROFF,0,11/
   24885, 28800, 1, 37180, 12800, 2, 34369, 22680, 2, 32338, 24847, 2,
   2400, 0, 3, 32600, 0, 4, 14960, 0, 5, 14979, 14565, 5, 14980, 24000, 5,
   7023, 22400, 6, 34240, 0, 7, 34164, 8720, 8, 24240, 0, 9, 24560, 0, 10,
   24246, 0, 11
};
...
//     & 2RIN,0,"32000,
//     & 3RCRO,2RSS,"36000/
   22400, 0, 1024, 23018, 32320, 1024, 30400, 0, 5120,
   8000, 0, 3072, 8059, 32000, 3072, 36800, 0, 7168, 37019, 32000, 7168,
   30600, 0, 4096, 31320, 0, 6144,
   22600, 0, 2048, 23320, 0, 8192,
   33600, 0, 9216, 34240, 0, 9216, 6400, 0, 10240, 7023, 22400, 10240,
   19261, 22528, 11264, 19254, 6400, 12288, 8580, 8720, 13312,
   8969, 32000, 14336, 24860, 0, 14336, 19401, 35400, 14336,
   32721, 35412, 15360, 31021, 32320, 5120,
   14960, 0, 13312,
   5535, 31160, 15360
};
...
// int avoc1[184];
   3935, 37360, 1, 81, 8495, 22681, 1, 13420, 0, 3, 25816, 25818, 3,
...
// int avoc2[114];
   10335, 23200, 68, 31215, 22600, 69, 150, 214, 20854, 11685, 72,
   ...
   3921, 14565, 101,
   11261, 7400, 108, 31101, 2325, 109, 127, 5281, 40000, 109,
   30729, 23400, 110, 32329, 22400, 110,
   11925, 8560, 115, 143, 26458, 26085, 116, 37129, 32200, 117, 147, 160,
...
// int avoc3[106];
   29403, 18600, 147, 30725, 8720, 147,
...
// int vvoc1[92];
   3929, 8240, 1, 70, 35418, 3819, 1, 71,
...
// int vvoc1a[108];
   5135, 21440, 19819, 8000, 3258, 9600, 1, 45,
   ...
   13416, 0, 30849, 25600, 1, 53, 10443, 17600, 30729, 32000, 6453, 22400,
   5658, 30600, 1, 54, 42218, 17600, 1, 55, 11921, 22780, 1, 20536,
...
// int vvoc1b[38];
   1881, 14960, 1, 57, 23015, 3600, 1, 58,
...
// int vvoc2[104];
   6606, 19260, 1, 20583,
   6619, 5529, 37121, 32000, 8961, 21174, 1, 20600,
   9972, 19200, 11, 24710, 25088, 128, 0, 25090, 256, 0,
   16518, 25088, 128, 0,
   9974, 6400, 30605, 17600, 37125, 29000, 30605, 0, 4, 16511, 24576, -1, -1,
   10212, 19823, 2, 85, 20565,
   17963, 17600, 3580, 8000, 32061, 23200, 1, 20587, 19823, 8720, 1, 20590,
   26459, 12800, 26325, 31160, 1, 20592, 29174, 11200, 25801, 19200, 1, 20567,
   29642, 0, 4858, 8779, 32621, 5120, 10214, 6885, 1, 20591,
...
// int vvoc3[136];
   2420, 1731, 9967, 13600, 14970, 34325, 13180, 0, 13658, 32000,
   7, 24717, 8704, 0, 128, 18434, 0, 512,
   3801, 28960, 4, 16514, 8704, 0, 2,
   3941, 30720, 5285, 2160, 5, 21592, 28760, 25090, -1, -1,
   4058, 22400, 14694, 15205, 14963, 14965, 7, 24713, 25088, 16, 0,
   26626, 8, 0,
   5289, 20880, 12, 16541, 8199, 0, 2048,
   16542, 8198, 0, 2048, 16540, 8192, 0, 2048,
   5295, 30600, 4, 16510, 25088, 4224, 0,
   6767, 0, 4, 16473, 18434, 4, 0,
   6779, 8522, 4, 16515, 8192, 0, 2,
   7129, 22840, 14922, 14485, 31321, 19695, 4, 16520, 25088, 256, 0,
   7135, 25600, 29012, 8059, 11, 17553, 16896, -1, -1,
   24721, 16896, -1, -1, 25093, -1, -1,
...
// int vvoc4[116];
   11582, 8000, 12854, 6400, 7014, 2405, 11, 29842, 8708,
   32, 0, 26770, 8704, 32, 0, 25088, -1, -1,
   13012, 19800, 13160, 0, 2, 1175, 20631,
   3695, 36800, 15, 25702, 25095, -1, -1, 25090, 4, 0,
   16496, 25095, -1, -1, 16501, 25093, -1, -1,
   14966, 19260, 4, 28774, 25090, 4, 0,
   16853, 25600, 19401, 25600, 5, 91, 16475, 25089, -1, -1,
   17972, 19200, 21658, 6618, 30881, 40000, 31201, 3200, 6779, 25660,
   7, 24715, 8704, 0, 128,
   18434, 0, 512,
   18175, 5240, 28856, 0, 12, 17526, 25091, -1, -1,
   16502, 25098, -1, -1, 16525, 9734, 32, 0,
...
// int vvoc5[134];
   19815, 17600, 19200, 0, 31201, 29000, 11266, 8000,
   13, 119, 16503, 24579, -1, -1,
   16537, 25096, -1, -1, 16536, 24581, -1, -1,
   21012, 32000, 19577, 33966, 4, 28773, 25090, 8, 0,
   21422, 8000, 4, 16506, 8192, -1, -1,
   26452, 19200, 32847, 0, 8, 17530, 8704, -1, -1,
   16506, 8714, -1, -1,
   21654, 11200, 12843, 17600, 10335, 3200, 6453, 1885,
   5, 21642, 28810, 18434, -1, -1,
   24645, 22400, 11, 17533, 25088, 4224, 0,
   24701, 25088, 4224, 0, 22530, 4, 512,
   25963, 17600, 4, 16516, 25095, 8192, 32,
   26101, 11200, 11701, 8000, 25660, 5120, 4, 28778, 25090, -1, -1,
   26211, 8000, 3925, 2040, 16042, 0, 7, 24714, 8704, 0, 128,
   18434, 0, 512,
...
// int vvoc6[117];
   26460, 0, 14979, 8740, 31221, 9840, 26081, 5000,
   8, 29840, 25093, -1, -1,
   16529, 25094, -1, -1,
   28849, 30600, 19566, 32000, 5, 21613, 16493, 25095, -1, -1,
   29001, 6400, 30849, 20800, 11, 17508, 29184, 16384, 0,
   24676, 29184, 16384, 0, 25090, -1, -1,
   31218, 14845, 12, 24717, 9728, 32, 0,
   18434, 0, 512, 17549, 9728, 32, 0, 20603,
   31329, 22680, 32338, 34380, 7, 24716, 18432, 0, 512,
   8707, 0, 128,
   32051, 8000, 11420, 0, 13412, 6400, 4858, 29800, 29013, 24885,
   4, 16516, 25088, 8192, 32,
...
// int vvoc7[89];
   32365, 0, 9659, 32214, 11, 28786, 25092, -1, -1,
   24691, 8704, 32, 0, 27138, 4, 0,
   32858, 22400, 30620, 0, 22, 25716, 25088, 2, 0,
   26626, 4, 0,
   16507, 31242, 64, 0, 16508, 31243, 64, 0,
   24735, 25088, 2, 0, 8196, -1, -1,
   34172, 24131, 7, 24669, 8704, -1, -1,
   30722, 4, 0,
   36851, 8000, 31258, 26329, 2081, 29320, 31201, 29612,
   8, 17512, 8192, 32, 0,
   16488, 8199, 32, 0,
   36862, 8000, 10081, 34180, 3921, 22569, 4, 16492, 16384, -1, -1,
   37174, 6400, 5, 20635, 16539, 25095, -1, -1,
// int vvocnd;
   -1
};
...
// Same format as avoc.
// common /objvoc/ int ovoc1[160], ovoc2[144], ovoc3[150], ovoc4[128], ovoc5[111], ovoc6[104], ovoc6a[97], ovoc7[127], ovocnd;
...
// int ovoc3[150];
   11815, 6495, 47, 4854, 6885, 48, 25649, 28800, 48,
   12049, 6602, 49,
   12049, 6600, 49, 25656, 8720, 50, 122, 143, 186, 22623, 31041, 50,
   ...
   5529, 21174, 61, 3254, 6780, 61, 5535, 24440, 61, 11414, 32000, 61,
...
//     & 3RPUM,1RP,89/
// int ovoc4[128];
   37174, 7023, 63, 3812, 32000, 64, 23260, 0, 64,
...
// int ovoc5[111];
   1978, 26453, 89, 1978, 43861, 89, 19242, 8480, 91, 112,
...
// int ovoc6a[97];
   25654, 8480, 159, 160, 161, 162, 163, 164, 213,
...
// int ovoc7[127];
   21000, 0, 193, 21819, 8486, 193, 5525, 32374, 193,
