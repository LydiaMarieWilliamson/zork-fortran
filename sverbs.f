...
C Initialized data
	...
	DATA ANSWER/0,1,2,3,4,4,4,4,5,5,5,6,7,7/
	DATA ANSWERN/6,6,5,5,3,6,6,5,5,4,6,10,4,6/
...
C
21000	PLAYTIME=GTTIME()
C						!GET PLAY TIME.
	I=PLAYTIME/3600
	J=MOD(PLAYTIME,3600)/60
	K=MOD(PLAYTIME,60)
C
	WRITE(OUTCH,21010)
	IF(I.GE.100)THEN
...
21011	FORMAT('over 100 hours.')
21012	FORMAT(I2,' hour(s), ',$)
21013	FORMAT(I2,' minute(s), and '$)
21014	FORMAT(I2,' second(s).')
C
