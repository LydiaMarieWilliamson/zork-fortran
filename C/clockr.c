...
static integer c__537 = 537;
static integer c__538 = 538;
static integer c__539 = 539;
static integer c__540 = 540;
static integer c__541 = 541;
static integer c__542 = 542;
...
#define switch__ ((integer *)&findex_1 + 46)
   extern /* Subroutine */ int rspeak_(integer *), jigsup_(integer *), litint_(integer *, integer *, integer *, integer *, integer *), newsta_(integer *, integer *, integer *, integer *, integer *), rspsub_(integer *, integer *), scrupd_(integer *);
   extern integer mrhere_(integer *);
   static logical f;
   static integer i__, j, bc, br;
...
#define rrand ((integer *)&rooms_1 + 602)
   extern logical rmdesc_(integer *), findxt_(integer *, integer *), moveto_(integer *, integer *);
