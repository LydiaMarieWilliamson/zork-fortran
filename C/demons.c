...
static integer c__591 = 591;
static logical c_true = TRUE_;
static integer c__592 = 592;
static integer c__593 = 593;
static integer c__594 = 594;
static integer c__595 = 595;
static integer c__10 = 10;
static integer c__25 = 25;
static integer c__605 = 605;
static integer c__572 = 572;
static integer c__596 = 596;
...
integer blow_(integer * h__, integer * v, integer * rmk, logical * hflg, integer * out) {
/* Initialized data */
...
/* 						!ASSUME NO RESULT. */
   ...
   do_fio(&c__1, (char *)&(*v),(ftnlen) sizeof(integer));
   do_fio(&c__1, (char *)&(*rmk),(ftnlen) sizeof(integer));
   do_fio(&c__1, (char *)&(*hflg),(ftnlen) sizeof(logical));
   do_fio(&c__1, (char *)&(*out),(ftnlen) sizeof(integer));
   e_wsfe();
   if (!(*hflg)) {
      goto L1000;
   }
...
/* 						!DONT ALLOW DEAD DEF. */
   ...
   dweap = (i__1 = fwim_(&c__0, &oflags_1.weapbt, &c__0, &c__0, h__, &c_true)
      , abs(i__1));
/* 						!FIND A WEAPON. */
/* BLOW, PAGE 4 */
...
L2000:
   ...
   do_fio(&c__1, (char *)&def, (ftnlen) sizeof(integer));
   do_fio(&c__1, (char *)&od, (ftnlen) sizeof(integer));
   do_fio(&c__1, (char *)&dweap, (ftnlen) sizeof(integer));
   e_wsfe();
   if (def > 0) {
      goto L2100;
   }
...
/* 						!CHOOSE TABLE ENTRY. */
   ...
   s_wsfe(&io___56);
   do_fio(&c__1, (char *)&res, (ftnlen) sizeof(integer));
   do_fio(&c__1, (char *)&mi, (ftnlen) sizeof(integer));
...
/* Local variables */
   static integer i__, ng;
#define eqa ((integer *)&advs_1 + 1)
#define eqo ((integer *)&objcts_1 + 1)
#define eqv ((integer *)&vill_1 + 1)
#define xflag ((integer *)&curxt_1 + 4)
   extern logical infest_(integer *);
   extern /* Subroutine */ int rspeak_(integer *);
